...
- timestamp: 2026-05-25T02:01:49Z
- live_requested: True
- live_ran: True
- live_cases: 32
- skipped_reason: n/a
...
| --- | --- |
| total_cases | 32 |
| schema_valid_rate | 0.938 |
| expected_family_match_rate | 0.864 |
| acceptable_family_match_rate | 0.781 |
| evidence_grounded_rate | 0.781 |
| clarification_needed_match_rate | 0.656 |
| expected_context_match_rate | 0.625 |
| hallucinated_observation_count | 0 |
| unsafe_action_override_count | 0 |
| not_action_level_violation_count | 0 |
...
| --- | --- |
| debug_case_count | 32 |
| api_success_count | 30 |
| raw_json_returned_count | 30 |
| raw_observation_count | 35 |
| accepted_observation_count | 30 |
| zero_accepted_observation_cases | 7 |
| rejection_reason_counts | api_error:2, low_confidence:2, pydantic_validation_error:3 |
...
| clear_red_flag_002 | True | True | _live_eval_raw_body, observations | 2 | 2 | none |
| clear_red_flag_003 | True | True | _live_eval_raw_body, observations | 2 | 2 | none |
| clear_red_flag_004 | True | True | _live_eval_raw_body, observations | 2 | 2 | none |
| clear_red_flag_005 | True | True | _live_eval_raw_body, observations | 2 | 2 | none |
| clear_red_flag_006 | False | False | _live_eval_error, observations | 0 | 0 | api_error:1 |
| missing_info_001 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| missing_info_002 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| missing_info_003 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| missing_info_004 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| missing_info_005 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| missing_info_006 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| mild_transient_001 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| mild_transient_002 | False | False | _live_eval_error, observations | 0 | 0 | api_error:1 |
| mild_transient_003 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| mild_transient_004 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| mild_transient_005 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| mild_transient_006 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| chronic_progressive_001 | True | True | _live_eval_raw_body, observations | 1 | 0 | pydantic_validation_error:1 |
| chronic_progressive_002 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| chronic_progressive_003 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| chronic_progressive_004 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| chronic_progressive_005 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| chronic_progressive_006 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| ambiguous_lay_001 | True | True | _live_eval_raw_body, observations | 1 | 0 | pydantic_validation_error:1 |
| ambiguous_lay_002 | True | True | _live_eval_raw_body, observations | 1 | 0 | pydantic_validation_error:1 |
| ambiguous_lay_003 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| ambiguous_lay_004 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| ambiguous_lay_005 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| ambiguous_lay_006 | True | True | _live_eval_raw_body, observations | 1 | 0 | low_confidence:1 |
| ambiguous_lay_007 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |
| ambiguous_lay_008 | True | True | _live_eval_raw_body, observations | 1 | 0 | low_confidence:1 |

| case | action | families | clarify | grounded | hallucinated |
| --- | --- | --- | --- | --- | --- |
| clear_red_flag_001 | emergency_now | facial_asymmetry, weakness | False | True | 0 |
| clear_red_flag_002 | emergency_now | sensory, speech_language | True | True | 0 |
| clear_red_flag_003 | emergency_now | confusion_awareness, fall_head_injury | True | True | 0 |
| clear_red_flag_004 | emergency_now | facial_asymmetry, speech_language | False | True | 0 |
| clear_red_flag_005 | same_day_review | gait_balance, vision | False | True | 0 |
| clear_red_flag_006 | monitor |  | True | False | 0 |
| missing_info_001 | monitor | sensory | True | True | 0 |
| missing_info_002 | monitor | confusion_awareness | True | True | 0 |
| missing_info_003 | monitor | weakness | True | True | 0 |
| missing_info_004 | monitor | headache | True | True | 0 |
| missing_info_005 | monitor | gait_balance | True | True | 0 |
| missing_info_006 | monitor | speech_language | True | True | 0 |
| mild_transient_001 | monitor | sensory | True | True | 0 |
| mild_transient_002 | monitor |  | True | False | 0 |
| mild_transient_003 | monitor | fatigue | True | True | 0 |
| mild_transient_004 | monitor | vision | True | True | 0 |
| mild_transient_005 | monitor | headache | True | True | 0 |
| mild_transient_006 | monitor | other | True | True | 0 |
| chronic_progressive_001 | monitor |  | True | False | 0 |
| chronic_progressive_002 | same_day_review | speech_language | False | True | 0 |
| chronic_progressive_003 | same_day_review | gait_balance | False | True | 0 |
| chronic_progressive_004 | monitor | other | False | True | 0 |
| chronic_progressive_005 | monitor | memory_cognitive | True | True | 0 |
| chronic_progressive_006 | monitor | weakness | False | True | 0 |
...
| failed case | failures |
| --- | --- |
| clear_red_flag_002 | clarification |
| clear_red_flag_003 | clarification |
| clear_red_flag_005 | emergency_not_preserved |
...
| mild_transient_003 | clarification |
| mild_transient_004 | clarification |
| mild_transient_005 | clarification |
| chronic_progressive_001 | expected_family, acceptable_family, evidence_grounding, clarification, expected_context |
| chronic_progressive_002 | expected_context |
| chronic_progressive_003 | expected_context |
| chronic_progressive_004 | clarification, expected_context |
| chronic_progressive_005 | clarification |
| chronic_progressive_006 | expected_context |
...
| schema_valid_rate | 0.938 |
| expected_family_match_rate | 1.000 |
| acceptable_family_match_rate | 0.969 |
| evidence_grounded_rate | 1.000 |
| clarification_needed_match_rate | 0.781 |
| expected_context_match_rate | 0.906 |
| hallucinated_observation_count | 1 |
| unsafe_action_override_count | 0 |
| not_action_level_violation_count | 0 |
| emergency_preservation_rate | 1.000 |
...
| missing_info_005 | monitor | gait_balance | True | True | 0 |
| missing_info_006 | monitor | speech_language | True | True | 0 |
| mild_transient_001 | monitor | sensory | False | True | 0 |
| mild_transient_002 | monitor | sensory | True | True | 0 |
| mild_transient_003 | monitor | fatigue | True | True | 0 |
| mild_transient_004 | monitor | vision | True | True | 0 |
| mild_transient_005 | monitor | headache | True | True | 0 |
