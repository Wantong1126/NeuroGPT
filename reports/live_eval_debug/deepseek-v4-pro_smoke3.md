...
- timestamp: 2026-05-25T01:55:29Z
- live_requested: True
- live_ran: True
- live_cases: 3
- skipped_reason: n/a
...
| expected_family_match_rate | 0.333 |
| acceptable_family_match_rate | 0.667 |
| evidence_grounded_rate | 0.667 |
| clarification_needed_match_rate | 0.333 |
...
| clear_red_flag_003 | True | True | _live_eval_raw_body, observations | 1 | 1 | none |

| case | action | families | clarify | grounded | hallucinated |
| --- | --- | --- | --- | --- | --- |
| clear_red_flag_001 | emergency_now | facial_asymmetry, weakness | False | True | 0 |
| clear_red_flag_002 | monitor |  | True | False | 0 |
| clear_red_flag_003 | emergency_now | confusion_awareness | True | True | 0 |
...
| clear_red_flag_003 | expected_family, clarification |
