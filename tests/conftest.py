...
def _disable_live_llm_by_default(monkeypatch, request):
    ...
    from modules import elder_explanation_generator, observation_extractor_llm, symptom_extractor
    ...
    monkeypatch.setattr(observation_extractor_llm, "get_provider", lambda _module: "heuristic")
